...
\begin{document}
	...
	\begin{align}
		...
		{\gls{s:modulo-elast-efetivo}\gls{s:raio-equiv-x}}
	...
	\subsubsection{Propriedades dinâmicas do filme de fluido}
	...
	No experimento, os resultados foram ajustados, e os valores para \gls{s:rig-naolin-filme} e \gls{s:forca-sust-filme} para diversas velocidades de rotação e carga radial constante são apresentados na \tablename\ \ref{tbl:props-filme}.
	...
	\begin{table} \label{tbl:props-filme}
		\begin{tabular}{l|l|l|l|l|l}
			\toprule \bfseries
			Velocidade de rotação [RPM] & Carga radial [N] &
			$\gls{s:rig-naolin-filme} \cdot 10^8$
			[N/m\textsuperscript{\gls{s:exp-naolin}}] &
			\gls{s:exp-naolin} & \gls{s:forca-sust-filme} [N] &
			Resíduo\\ \midrule
		\end{tabular}
	\end{table}
