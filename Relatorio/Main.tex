...
\begin{document}
	...
	A variação instantânea da força nesse perfil indica um valor muito alto -- teoricamente, infinito -- da derivada da aceleração, chamada de impulso ou \foreignlanguage{english}{jerk} \cite{norton:2010}.
