...
\begin{document}
	...
	Um gráfico com o perfil dos impulsos ao longo do tempo é exibido na \figurename\ \ref{fig:modelo-impulsos}.
	
	\begin{figure}[b]
		\incluirimagem[0.7]{ModeloImpulsos.png}{Perfil de impactos ao longo do tempo}{o autor (\thedate)}
