...
\begin{document}
	...
	\begin{figure}[t]
		\incluirimagem[0.65]{SistemaVariosGrausLiberdade.png}{Sistema com vários graus de liberdade}{\citeauthoronline{rao:2008} (\citeyear{rao:2008})}
	...
	\begin{figure}[H]
		\incluirimagem[0.55]{ModeloExtAccEnvSpecSideBands.png}{Bandas laterais no espectro de envelope}{o autor (\thedate)}
