...
\begin{document}
	...
	Assim como na determinação do amortecimento, os valores para o filme no anel externo e interno são iguais, mas se adotará conjuntos de variáveis individuais para cada parte.
	...
	O vetor com as componentes da força de restauração desta camada 
