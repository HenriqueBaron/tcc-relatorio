...
\begin{document}
	...
	\subsection{Determinação de condições iniciais}
	Para encontrar a solução particular do sistema matricial da Equação \ref{eqn:mdl:sistema}, são necessárias seis condições iniciais.
	...
	A posição inicial do anel externo também será tomada como zero, enquanto as posições iniciais dos outros componentes dependem da espessura do filme de fluido, cujo método de obtenção é apresentado no item \ref{sec:ehl:simpl}.
