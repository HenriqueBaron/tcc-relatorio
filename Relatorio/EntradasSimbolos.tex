...
\newglossaryentry{s:modulo-elast}{name={\ensuremath{E}},description={módulo de elasticidade \unidadepressao }}
\newglossaryentry{s:segundo-momento-area}{name={\ensuremath{I}},description={segundo momento de área \unidadesegundomomento}}
\newglossaryentry{s:numero-amostras}{name={\ensuremath{N}},description={número de amostras de dados coletadas \semunidade}}

% Fourier
\newglossaryentry{s:funcao-tempo}{name={\ensuremath{g(t)}},description={função no domínio do tempo \semunidade}}
\newglossaryentry{s:funcao-freq}{name={\ensuremath{G(\omega)}},description={função no domínio da frequência \semunidade}}
\newglossaryentry{s:matriz-unitarios-dft}{name={\ensuremath{[\mathbf{A}]}},description={matriz quadrada de vetores unitários \semunidade}}
\newglossaryentry{s:vetor-matriz-unit-dft}{name={\ensuremath{\mathbf{a}_{kn}}},description={vetores unitários da matriz \glsentrytext{s:matriz-unitarios-dft}}}
\newglossaryentry{s:coef-fourier-compl}{name={\ensuremath{\alpha_n}},description={coeficiente complexo de Fourier \semunidade}}

% Massa
\newglossaryentry{s:massa-espec}{name={\ensuremath{\rho}},description={massa específica por unidade de comprimento \unidademassalinear}}
...
% Frequência
\newglossaryentry{s:freq-rad}{name={\ensuremath{\omega}},description={frequêcia \unidadevelocidadeangular}}
\newglossaryentry{s:freq:hz}{name={\ensuremath{\mathit{f}}},description={frequência \unidadefrequencia}}
\newglossaryentry{s:freq-amostra}{name={\ensuremath{\mathit{f}_s}},description={frequência de amostragem \unidadefrequencia}}
...
\newglossaryentry{s:sol-parcial-pos}{name={\ensuremath{W}},description={solução parcial, dependente da posição x \semunidade}}
\newglossaryentry{s:sol-parcial-tempo}{name={\ensuremath{T}},description={solução parcial, dependente do tempo \semunidade}}
...
\newglossaryentry{s:coef-fourier-int}{name={\ensuremath{a_\omega, b_\omega}},description={coeficientes de Fourier \semunidade},expansao={\ensuremath{a_\omega} e \ensuremath{b_\omega}}}